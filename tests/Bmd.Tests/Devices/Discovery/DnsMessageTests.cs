...
{
    // Golden response is shared with MdnsClientTests via DiscoveryFixtures.ResponseHex.
    static byte[] Response() => Convert.FromHexString(DiscoveryFixtures.ResponseHex);
