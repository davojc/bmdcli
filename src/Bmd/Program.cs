...
// Per-command help is generated by ConsoleAppFramework, which emits each description as one
// unwrapped line and leaves the terminal to break it at column zero. Capturing that output and
// reflowing it keeps the generator as the single source of truth for what the flags are, while
// fixing how they are laid out — see HelpText for why this is not a hand-written help renderer.
// Root and group help never reach here; GroupHelp handles those above.
if (args.Any(a => a is "--help" or "-h"))
{
    ...
    console.Write(HelpText.Reflow(captured.ToString(), HelpText.ConsoleWidth()));
